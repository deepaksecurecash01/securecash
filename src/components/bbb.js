...
const BannerInfo = () => (
  <Container>
    <div className="w-full mx-auto inline-block bg-black relative top-[-34px] py-2.5 px-0 text-white text-sm 480px:pt-2.5  480px:pb-5 1024px:rounded-[40px] 1024px:py-0 1024px:px-0  1024px:w-[95%] 1366px:w-full">
      <div className="flex flex-col 1024px:flex-row justify-center items-center mx-auto">

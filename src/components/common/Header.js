...
const Navbar = () => {
  ...
  return (
    <Headroom className="z-50 ">
      <header className=" bg-white w-full h-auto top-0 transition-all duration-500 shadow-[0_1px_6px_0_rgba(32,33,36,.28)]">
        <div className="w-full max-w-[1366px] mx-auto pt-2.5 1024px:pb-2.5 flex justify-evenly items-center">
          <div className="w-full 1024px:w-[95%] 1366px:w-full 1600px:w-full flex 1024px:flex-row flex-col justify-center items-center">
            ...
            <div
              id="mobile-menu"
              className="block 1024px:hidden h-full w-full"
            >
              <button

...
import { UNIFIED_SPECIAL_EVENT_SCHEMA, UNIFIED_SPECIAL_EVENT_DEFAULT_VALUES } from "@/zod/SpecialEventFormSchema";
...
const SpecialEventForm = () =>
{
  const formManager = useFormManager({
    ...
    prepareData: async (data) => ({ ...data, formType: "specialevent" }),
  });
  ...
  return (
    <>
      <div id="content-contact" className="480px:bg-content-bg bg-center bg-cover bg-no-repeat inline-block w-full 992px:my-[40px] 1280px:my-[120px]">

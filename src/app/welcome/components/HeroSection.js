      ...
      <Container className="w-[95%]  1366px:w-full flex flex-wrap justify-start items-center h-full ">
        ...
        >
          ...
          <div className="flex justify-start items-center 1366px:justify-start ml-5">
            <a
              className=" h-auto py-4 px-10 1366px:w-[253px]  1366px:h-[73px]  text-center border-0 cursor-pointer  hover:no-underline bg-black text-white  1366px:text-[16px]  1366px:px-[51px]  1366px:py-[21px] rounded-none font-['Montserrat'] hover:bg-[#c7a652] hover:text-black btn-welcome-hero text-xs 1366px:text-base"

...
const HeroLeftContent = () => (
  <div className="welcome-main-hero--content-left relative text-white w-full text-center 600px:text-left pt-[66px] pb-[56px]  600px:pt-[138px]  600px:pr-0  600px:pb-[128px]  600px:pl-[12px]  
  600px:w-2/5 768px:pl-6  768px:pt-[170px]  768px:pb-[153px]   1024px:pl-[18px] 1024px:w-2/4 welcome-main-hero--content-left-tnc">
    ...
    <div
      ...
      id="ins-pane-trigger"
    >
      <a className="py=[18px] px-[25px]" href={"#tnc-page-main-scroll"}>

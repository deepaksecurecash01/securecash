...
const BlogHeroSection = ({title, date, blogIndex}) => {
    // Determine title styling based on blogIndex
    const titleStyles = blogIndex 
        ? "blog-single-hero--head__title blog-index-hero--content__title text-[28px] leading-[34px] px-[10px] w-full  480px:text-[38px]  480px:leading-[36px]  480px:px-[40px] 768px:px-0 mb-[20px] text-center  768px:text-[46px] font-extrabold  768px:leading-[50px] capitalize  480px:w-[590px]"
            ...
            <Container className="w-full">
                <div className="blog-single-hero--wrap flex items-center relative">
                    <div className="blog-single-hero--head h-[290px] p-0 max-w-[900px] mx-auto flex flex-col justify-center items-center 768px:h-[340px]">
                        ...
                        <Divider color="primary"  className="w-[100px] mx-auto mt-[6px] mb-[16px]"/>

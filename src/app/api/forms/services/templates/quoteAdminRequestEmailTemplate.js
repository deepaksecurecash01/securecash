// Enhanced helper functions to check if sections have real data
const hasBankingData = (formData) =>
{
    const bankingFields = [
        'BankingFrequency',
        'BankingAmount',
...
const quoteAdminRequestEmailTemplate = (formData) =>
{
    ...
    // 🚀 ENHANCED LOGIC: Check if sections have actual data
    ...
    // Generate conditional sections - only if they have real data
    ...
    console.log('📧 Email template rendering:', {
        ...
        showBankingSection,
        showChangeSection,
        bankingSectionLength: bankingSection.length,
        changeSectionLength: changeSection.length
    });

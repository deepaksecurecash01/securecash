...
const TeamSlider = ({ member }) =>
{
    ...
    // State to manage arrow disable logic (replacing Slick's internal state)
    ...
    // Replicated CustomArrow component tailored for Swiper state
    ...
    return (
        <div className="relative">
            {/* Custom Arrows Placed Outside Swiper to match original absolute positioning */}
            <CustomArrow
                direction="prev"
                onClick={handlePrev}
            ...
            {/* Swiper Container 
              Note: We keep spaceBetween={0} because the original 'team-item-wrapper' 
              uses a right margin (mr-[62px]) to create the gap. 
            */}
            <Swiper
                ref={sliderRef}
                ...
                spaceBetween={0}
                slidesPerView={1}
                navigation={false} // We use custom external arrows
                ...
                breakpoints={{
                    // Mobile (Default/Fallback logic equivalent)
                    0: {
                        slidesPerView: 1,
                        effect: 'fade',
                        fadeEffect: { crossFade: true },
                        speed: 800, // Matches the speed: 800 in original mobile settings
                        allowTouchMove: true,
                    },
                    // Breakpoint: 767 (Tablet/Desktop transition)
                    767: {
                        slidesPerView: 1,
                        effect: 'slide', // Turn off fade
                        speed: 600,
                    },
                    // Breakpoint: 992
                    992: {
            ...
            >
                {member?.map((member, index) => (
                    <SwiperSlide key={index}>
                        {/* Kept exact class names. 
                          Note: '1024px:mr-[62px]' creates the visual gap between slides 
                        */}
                        <div className="team-item-wrapper relative h-[calc(100%-50px)] 768px:h-[672px] 1024px:h-[824px] 1070px:h-[768px] 1200px:h-[710px] 1280px:h-[672px] max-w-[600px] 1024px:mr-[62px]">
                            <div

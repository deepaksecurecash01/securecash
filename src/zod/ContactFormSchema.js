...
const BaseContactFormSchema = z.object({
    ...
    Organisation: z.string().min(1, "Organisation name is required.").min(2, "Organisation name must be at least 2 characters long."),
    ...
    ChkCallBack: z.array(z.string()).optional().default([]),
    CallbackDate: z.date().optional().nullable(),
    CallbackTime: z.string().optional(),
    CallbackState: z.string().optional(),
    Message: z.string().min(1, "Please let us know how we can help.").min(10, "Please provide more detail (minimum 10 characters)."),
    BotField: CommonValidations.botField()
});

const validateCallbackFields = (data, ctx) =>
{
...
const ContactFormSchema = BaseContactFormSchema.superRefine(validateCallbackFields);
...
export const ContactPartialSchema = BaseContactFormSchema.partial();

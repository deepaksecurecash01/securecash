import { getCurrentDateTime, formatCallbackDate } from '../utils/Helpers.js';

// AUSTRAC email template - exact same HTML as original
export const generateAustracEmailTemplate = (formData) =>
{
...
// Base email structure for consistency
const getBaseEmailStructure = (content) => `
...
export const getContactAdminTemplate = (formData) =>
{
    const currentDateTime = getCurrentDateTime();
    ...
    const callbackSection = formData.ChkCallBack === 'Yes, please.' ? `
        <tr style="border:1px solid #dddddd;border-width:1px 0 1px 0;">
            <td colspan="2" style="padding:18px 12px 18px 12px;color:#222222;line-height:160%;text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;">
    ...
    return getBaseEmailStructure(mainContent + callbackSection);
};

// Contact form customer confirmation template
export const getContactConfirmationTemplate = () =>
{
    ...
    return getBaseEmailStructure(content);
};

        ...
        >
            <div className="inner-big w-[95%] mt-10 1280px:mt-0 max-w-[1366px] mx-auto my-0 992px:flex">
                ...
                <div className="right-contact-row w-[96%] 992px:w-1/2 mx-auto 992px:mx-0 pt-[35px] 992px:pt-0 [flex:1] 992px:pl-8">
                    <h3 className="text-[32px] leading-[1.6em] text-center mb-[16px] 992px:text-left font-prata-regular">
                        Make The Right Choice
                    </h3>

                    <hr className="w-[100px] mb-[24px] bg-primary h-[4px] rounded-[5px] border-0 mx-auto 992px:ml-0 992px:mr-auto" />

                    <h2 className="font-bold text-[40px] text-primary leading-[1.4em] text-center mb-[24px] 992px:text-left font-montserrat">
                    ...
                    <ScrollableSection className="h-auto 480px:w-[90%] 992px:w-full p-0 mx-auto 992px:h-[630px] 1200px:h-[658px] 1366px:h-[740px] bg-white mt-6 leading-[2]">
                        <ul className="list-none w-full 992px:pr-6">
                            {contentItems.map((item, index) => (
                                <li
                                    key={index}
                                    className="flex items-start"
                                    style={{
                                        marginTop: index === 0 ? '10px' : '26px'
                                    }}
                                >
                                    {/* ✅ OPTIMIZED: React-Icons checkmark (0KB added - already in bundle) */}
                                    <IoCheckmarkSharp
                                        className="flex-shrink-0 text-primary mt-2.5 mr-3"
                                        size={20}
                                        aria-hidden="true"
                                    />
                                    ...
                                    <span className="flex-1">
                                        <h4
                                            className="text-xl leading-[30px] font-bold text-black mb-2.5"
                                            style={{
                                        ...
                                        <p className="text-base leading-8 text-black font-light">
                                            {item.content}
                                        </p>
                                    </span>
                                </li>

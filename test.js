...
const QuoteForm = ({ className }) =>
{
	...
	// ✅ Render success message with reset button
	const renderSuccessMessage = () =>
	{
		const userName = formManager.getStepData().Name || "";
		return (
			<div className="form-page success text-center flex flex-col justify-center items-center 992px:h-[70%]">
				...
				<div className="button-controls-container w-[80%] mx-auto mt-8">
					<button
						...
						className="bg-[#c6a54b] text-white border-none py-[15px] text-[17px] cursor-pointer w-full rounded-[40px] outline-none appearance-none hover:opacity-80 text-sm p-2.5 shadow-none font-montserrat"
					>
						Want Another Quote?
					</button>
				</div>
	...
	return (
		...
		>
			...
			>
				...
				{/* Render current step or success message */}
